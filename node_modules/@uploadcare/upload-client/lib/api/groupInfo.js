...
function groupInfo(id, _a) {
    var publicKey = _a.publicKey, _b = _a.baseURL, baseURL = _b === void 0 ? defaultSettings_1.default.baseURL : _b, cancel = _a.cancel, source = _a.source, integration = _a.integration, _c = _a.retryThrottledRequestMaxTimes, retryThrottledRequestMaxTimes = _c === void 0 ? defaultSettings_1.default.retryThrottledRequestMaxTimes : _c;
    return retryIfThrottled_1.default(function () {
        return request_node_1.default({
            ...
            url: getUrl_1.default(baseURL, '/group/info/', {
                jsonerrors: 1,
                pub_key: publicKey,
                group_id: id,
                source: source
